...
def userdashboard(current_user):
    if current_user:
        pass
        return render_template("userdashboard.html", username=current_user.username)   
...
# def admindashboard(current_user):
#     if current_user:
#         return render_template("admindashboard.html", user_name=current_user.name)
...
# def userdashboard(current_user):
#     if current_user:
#         return render_template("userdashboard.html", user_name=current_user.name)
